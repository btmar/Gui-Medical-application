...
angular
        ...
        .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
                ...
                $stateProvider
                        ...
                        .state('dashboard.updateTProzedur', {
                            templateUrl: 'views/update/updateProzedur.html',
                            url: '/update/updateProzedur/:title',
                            controller: 'ProzedurBearbeitenCtrl',
                            resolve: {
                                loadMyFiles: function ($ocLazyLoad) {
                                    return $ocLazyLoad.load({
                        ...
                        .state('dashboard.updateTKrankheit', {
                            templateUrl: 'views/update/updateKrankheit.html',
                            url: '/update/updateKrankheit/:title',
                            controller: 'KrankheitBearbeitenCtrl',
                            resolve: {
                                loadMyFiles: function ($ocLazyLoad) {
                                    return $ocLazyLoad.load({
